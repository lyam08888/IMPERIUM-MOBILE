...
function creerInterfaceGererCommerceMonde() {
    const container = document.createElement('div');
    container.className = 'gerercommercemonde-interface';
    ...
    container.innerHTML = `
        <div class="action-panel">
            ...
            <div class="action-buttons">
                <button class="btn primary" onclick="gererCommerceMonde()">
                    Ex̩cuter
                </button>
...
if (typeof window !== 'undefined') {
    ...
    window.creerInterfaceGererCommerceMonde = creerInterfaceGererCommerceMonde;
}

console.log('Module gererCommerceMonde charg̩');
