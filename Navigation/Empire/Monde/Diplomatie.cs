...
function creerInterfaceGererDiplomatieMonde() {
    const container = document.createElement('div');
    container.className = 'gererdiplomatiemonde-interface';
    ...
    container.innerHTML = `
        <div class="action-panel">
            ...
            <div class="action-buttons">
                <button class="btn primary" onclick="gererDiplomatieMonde()">
                    Ex̩cuter
                </button>
...
if (typeof window !== 'undefined') {
    ...
    window.creerInterfaceGererDiplomatieMonde = creerInterfaceGererDiplomatieMonde;
}

console.log('Module gererDiplomatieMonde charg̩');
