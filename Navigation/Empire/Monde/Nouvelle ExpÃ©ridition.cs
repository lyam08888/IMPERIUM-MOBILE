...
function creerInterfaceCreerNouvelleExpedition() {
    const container = document.createElement('div');
    container.className = 'creernouvelleexpedition-interface';
    ...
    container.innerHTML = `
        <div class="action-panel">
            ...
            <div class="action-buttons">
                <button class="btn primary" onclick="creerNouvelleExpedition()">
                    Ex̩cuter
                </button>
...
if (typeof window !== 'undefined') {
    ...
    window.creerInterfaceCreerNouvelleExpedition = creerInterfaceCreerNouvelleExpedition;
}

console.log('Module creerNouvelleExpedition charg̩');
