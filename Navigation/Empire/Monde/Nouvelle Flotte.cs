...
function creerInterfaceCreerNouvelleFlotte() {
    const container = document.createElement('div');
    container.className = 'creernouvelleflotte-interface';
    ...
    container.innerHTML = `
        <div class="action-panel">
            ...
            <div class="action-buttons">
                <button class="btn primary" onclick="creerNouvelleFlotte()">
                    Ex̩cuter
                </button>
...
if (typeof window !== 'undefined') {
    ...
    window.creerInterfaceCreerNouvelleFlotte = creerInterfaceCreerNouvelleFlotte;
}

console.log('Module creerNouvelleFlotte charg̩');
