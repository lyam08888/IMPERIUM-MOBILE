...
function creerInterfaceGererMonde() {
    const container = document.createElement('div');
    container.className = 'gerermonde-interface';
    ...
    container.innerHTML = `
        <div class="action-panel">
            ...
            <div class="action-buttons">
                <button class="btn primary" onclick="gererMonde()">
                    Ex̩cuter
                </button>
...
if (typeof window !== 'undefined') {
    ...
    window.creerInterfaceGererMonde = creerInterfaceGererMonde;
}

console.log('Module gererMonde charg̩');
