...
function creerInterfaceCreerNouvelleCampagne() {
    const container = document.createElement('div');
    container.className = 'creernouvellecampagne-interface';
    ...
    container.innerHTML = `
        <div class="action-panel">
            ...
            <div class="action-buttons">
                <button class="btn primary" onclick="creerNouvelleCampagne()">
                    Ex̩cuter
                </button>
...
if (typeof window !== 'undefined') {
    ...
    window.creerInterfaceCreerNouvelleCampagne = creerInterfaceCreerNouvelleCampagne;
}

console.log('Module creerNouvelleCampagne charg̩');
