...
function creerInterfaceAfficherRapportBataille() {
    const container = document.createElement('div');
    container.className = 'afficherrapportbataille-interface';
    ...
    container.innerHTML = `
        <div class="action-panel">
            ...
            <div class="action-buttons">
                <button class="btn primary" onclick="afficherRapportBataille()">
                    Ex̩cuter
                </button>
...
if (typeof window !== 'undefined') {
    ...
    window.creerInterfaceAfficherRapportBataille = creerInterfaceAfficherRapportBataille;
}

console.log('Module afficherRapportBataille charg̩');
