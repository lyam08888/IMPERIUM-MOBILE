...
function creerInterfaceGererGaleresGuerre() {
    const container = document.createElement('div');
    container.className = 'gerergaleresguerre-interface';
    ...
    container.innerHTML = `
        <div class="action-panel">
            ...
            <div class="action-buttons">
                <button class="btn primary" onclick="gererGaleresGuerre()">
                    Ex̩cuter
                </button>
...
if (typeof window !== 'undefined') {
    ...
    window.creerInterfaceGererGaleresGuerre = creerInterfaceGererGaleresGuerre;
}

console.log('Module gererGaleresGuerre charg̩');
