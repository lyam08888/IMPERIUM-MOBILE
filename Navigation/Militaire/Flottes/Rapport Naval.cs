...
function creerInterfaceAfficherRapportNaval() {
    const container = document.createElement('div');
    container.className = 'afficherrapportnaval-interface';
    ...
    container.innerHTML = `
        <div class="action-panel">
            ...
            <div class="action-buttons">
                <button class="btn primary" onclick="afficherRapportNaval()">
                    Ex̩cuter
                </button>
...
if (typeof window !== 'undefined') {
    ...
    window.creerInterfaceAfficherRapportNaval = creerInterfaceAfficherRapportNaval;
}

console.log('Module afficherRapportNaval charg̩');
