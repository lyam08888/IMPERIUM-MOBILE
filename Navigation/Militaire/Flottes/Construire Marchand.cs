...
function creerInterfaceConstruireNavireMarchand() {
    const container = document.createElement('div');
    container.className = 'construirenaviremarchand-interface';
    ...
    container.innerHTML = `
        <div class="action-panel">
            ...
            <div class="action-buttons">
                <button class="btn primary" onclick="construireNavireMarchand()">
                    Ex̩cuter
                </button>
...
if (typeof window !== 'undefined') {
    ...
    window.creerInterfaceConstruireNavireMarchand = creerInterfaceConstruireNavireMarchand;
}

console.log('Module construireNavireMarchand charg̩');
