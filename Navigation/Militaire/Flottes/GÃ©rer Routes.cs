...
function creerInterfaceGererRoutesNavales() {
    const container = document.createElement('div');
    container.className = 'gererroutesnavales-interface';
    ...
    container.innerHTML = `
        <div class="action-panel">
            ...
            <div class="action-buttons">
                <button class="btn primary" onclick="gererRoutesNavales()">
                    Ex̩cuter
                </button>
...
if (typeof window !== 'undefined') {
    ...
    window.creerInterfaceGererRoutesNavales = creerInterfaceGererRoutesNavales;
}

console.log('Module gererRoutesNavales charg̩');
