...
function creerInterfaceCreerExpeditionNavale() {
    const container = document.createElement('div');
    container.className = 'creerexpeditionnavale-interface';
    ...
    container.innerHTML = `
        <div class="action-panel">
            ...
            <div class="action-buttons">
                <button class="btn primary" onclick="creerExpeditionNavale()">
                    Ex̩cuter
                </button>
...
if (typeof window !== 'undefined') {
    ...
    window.creerInterfaceCreerExpeditionNavale = creerInterfaceCreerExpeditionNavale;
}

console.log('Module creerExpeditionNavale charg̩');
