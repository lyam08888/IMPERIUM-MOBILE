...
function creerInterfaceGererNaviresExploration() {
    const container = document.createElement('div');
    container.className = 'gerernaviresexploration-interface';
    ...
    container.innerHTML = `
        <div class="action-panel">
            ...
            <div class="action-buttons">
                <button class="btn primary" onclick="gererNaviresExploration()">
                    Ex̩cuter
                </button>
...
if (typeof window !== 'undefined') {
    ...
    window.creerInterfaceGererNaviresExploration = creerInterfaceGererNaviresExploration;
}

console.log('Module gererNaviresExploration charg̩');
