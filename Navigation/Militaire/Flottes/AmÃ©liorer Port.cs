...
function creerInterfaceAmeliorerPort() {
    const container = document.createElement('div');
    container.className = 'ameliorerport-interface';
    ...
    container.innerHTML = `
        <div class="action-panel">
            ...
            <div class="action-buttons">
                <button class="btn primary" onclick="ameliorerPort()">
                    Ex̩cuter
                </button>
...
if (typeof window !== 'undefined') {
    ...
    window.creerInterfaceAmeliorerPort = creerInterfaceAmeliorerPort;
}

console.log('Module ameliorerPort charg̩');
