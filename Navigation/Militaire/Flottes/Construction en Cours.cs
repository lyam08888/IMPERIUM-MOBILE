...
function creerInterfaceAfficherConstructionsEnCours() {
    const container = document.createElement('div');
    container.className = 'afficherconstructionsencours-interface';
    ...
    container.innerHTML = `
        <div class="action-panel">
            ...
            <div class="action-buttons">
                <button class="btn primary" onclick="afficherConstructionsEnCours()">
                    Ex̩cuter
                </button>
...
if (typeof window !== 'undefined') {
    ...
    window.creerInterfaceAfficherConstructionsEnCours = creerInterfaceAfficherConstructionsEnCours;
}

console.log('Module afficherConstructionsEnCours charg̩');
